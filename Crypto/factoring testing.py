...
sheet1.write(0, 4, 'pollard rho brent time')
...
for i in range(1000):
    ...
    sheet1.write(i+1, 4, time4)
    sheet1.write(i+1, 5, str(factor2))

wb.save("factoringtimes.xls")

#2**24
#Regular Trial Division: 673.7 ms
#Prime Trial Division: 42.03 ms
#Pollard Rho: 16.49 ms
#Pollard Rho Brent: 14.86 ms